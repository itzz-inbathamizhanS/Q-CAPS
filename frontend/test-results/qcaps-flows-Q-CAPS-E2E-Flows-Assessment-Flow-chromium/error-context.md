...
- Name: qcaps-flows.spec.ts >> Q-CAPS E2E Flows >> Assessment Flow
- Location: tests\qcaps-flows.spec.ts:57:3
...
Call log:
  - waiting for locator('button:has-text("Begin Diagnostic Assessment")')
  ...
  - complementary [ref=e4]:
    ...
    - navigation [ref=e7]:
      ...
      - link "Curriculum Map" [ref=e17] [cursor=pointer]:
        - /url: /curriculum
      - link "Assessments" [active] [ref=e22] [cursor=pointer]:
        - /url: /assessment
  ...
  - generic [ref=e75]:
    ...
    - main [ref=e91]:
      - generic [ref=e92]:
        - generic [ref=e93]:
          - generic [ref=e94]:
            - heading "Module assessment" [level=2] [ref=e95]
            - paragraph [ref=e96]: Baseline Diagnostic v2.4
          - generic [ref=e98]:
            - generic [ref=e99]: Progress
            - generic [ref=e100]: Question 1 of 10
        - generic [ref=e103]:
          - generic [ref=e104]:
            - generic [ref=e105]: Q1. SEC.01 SECURITY CORE
            - heading "What is the primary objective of data confidentiality in information security?" [level=3] [ref=e111]
          - radiogroup "Question 1 options" [ref=e112]:
            - radio "Ensuring data cannot be modified by unauthorized users" [ref=e113] [cursor=pointer]
            - radio "Ensuring data is accessible only to authorized individuals" [ref=e116] [cursor=pointer]
            - radio "Ensuring systems remain continuously operational without interruption" [ref=e119] [cursor=pointer]
            - radio "Ensuring senders cannot deny transmitting a message" [ref=e122] [cursor=pointer]
        - generic [ref=e125]:
          - generic [ref=e126]:
            - button [disabled] [ref=e128] [cursor=pointer]
            - generic [ref=e132]:
              - button "Review answers" [ref=e133] [cursor=pointer]
              - button [ref=e134] [cursor=pointer]
          - button "Report issue with this question" [ref=e139] [cursor=pointer]
```
